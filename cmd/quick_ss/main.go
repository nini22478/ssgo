...
func main() {
	...
	//	}()
	//	logger.Infof("Metrics on http://%v/metrics", flags.MetricsAddr)https://aerodrome.onemelody.cn/
	//}

	var ipCountryDB *geoip2.Reader
	var err error

	api2 := api.New(&api.Config{APIHost: "http://47.92.220.167", LogHost: "http://vice.mobileairport.net/", Key: "fe6fcd397f783b5548c918e6a026bb2d"})
